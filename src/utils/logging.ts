...
const error = (error: unknown, message?: string, extra: Record<string, unknown> | string = {}) => {
  if (message) {
...
const fatal = (error: unknown, message?: string, extra: Record<string, unknown> | string = {}) => {
  if (message) {
    console.error(message, error, extra);
  } else {
    console.error(error, extra);
